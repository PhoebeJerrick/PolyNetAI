    ...
    return [
        ...
        },
        {
            ...
            "fields": [
                ...
                _field("dynamic_priority.phase_3_hedge_boost", "阶段3 对冲加仓幅度", "", min=0, max=50, step=1, risk="medium"),
                _field("dynamic_priority.phase_3_take_profit_sell_deboost", "阶段3 未达阈值时止盈卖出降权", "优先级数值加上此量（降权）。", min=0, max=30, step=1, risk="medium"),
                _field("dynamic_priority.phase_3_grid_sell_deboost", "阶段3 未达阈值时网格卖出降权", "", min=0, max=30, step=1, risk="medium"),
                _field("dynamic_priority.phase_3_buy_deboost_when_full", "阶段3 达阈值后买入降权", "", min=0, max=50, step=1, risk="medium"),
                _field("dynamic_priority.phase_3_take_profit_sell_boost_when_full", "阶段3 达阈值后止盈卖出提权", "", min=0, max=50, step=1, risk="medium"),
                _field("dynamic_priority.phase_3_grid_sell_boost_when_full", "阶段3 达阈值后网格卖出提权", "", min=0, max=50, step=1, risk="medium"),
            ],
        },
        ...
        },
        {
            ...
            "fields": [
                ...
                _field("grid.phase_1_low_percentile", "阶段1 网格低位分位", "未配置时回退 grid_low_percentile。", ui="range", min=0.01, max=0.5, step=0.01, risk="low"),
                _field("grid.phase_1_high_percentile", "阶段1 网格高位分位", "", ui="range", min=0.5, max=0.99, step=0.01, risk="low"),
                _field("grid.phase_2_low_percentile", "阶段2 网格低位分位", "", ui="range", min=0.01, max=0.5, step=0.01, risk="low"),
                _field("grid.phase_2_high_percentile", "阶段2 网格高位分位", "", ui="range", min=0.5, max=0.99, step=0.01, risk="low"),
                _field("grid.phase_3_low_percentile", "阶段3 网格低位分位", "", ui="range", min=0.01, max=0.5, step=0.01, risk="low"),
                _field("grid.phase_3_high_percentile", "阶段3 网格高位分位", "", ui="range", min=0.5, max=0.99, step=0.01, risk="low"),
                _field("grid.phase_4_low_percentile", "阶段4 网格低位分位", "", ui="range", min=0.01, max=0.5, step=0.01, risk="low"),
                _field("grid.phase_4_high_percentile", "阶段4 网格高位分位", "", ui="range", min=0.5, max=0.99, step=0.01, risk="low"),
        ...
        },
        {
            ...
            "fields": [
                ...
                _field("execution.min_same_outcome_price_move_ratio", "同向最小价格波动（全局兜底）", "未配置分阶段时生效。", ui="range", min=0.0, max=0.2, step=0.001, risk="medium"),
                _field("execution.phase_min_price_move_ratio.phase_1", "Phase 1 同向开仓最小波动", "0–70s 阶段，0 表示禁用。", ui="range", min=0.0, max=0.3, step=0.005, risk="medium"),
                _field("execution.phase_min_price_move_ratio.phase_2", "Phase 2 同向开仓最小波动", "70–160s 阶段，0 表示禁用。", ui="range", min=0.0, max=0.3, step=0.005, risk="medium"),
                _field("execution.phase_min_price_move_ratio.phase_3", "Phase 3 同向开仓最小波动", "160–240s 阶段，0 表示禁用。", ui="range", min=0.0, max=0.3, step=0.005, risk="medium"),
                _field("execution.phase_min_price_move_ratio.phase_4", "Phase 4 同向开仓最小波动", "240s+ 阶段，0 表示禁用。", ui="range", min=0.0, max=0.3, step=0.005, risk="medium"),
