...
from universal_stats_bot.core import load_stats_config, render_console_report, run_universal_stats
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "示例:\n"
            "  python -m universal_stats_bot.cli --config configs/batch.conf\n"
            "  python -m universal_stats_bot.cli --config configs/batch.conf --help"
        ),
